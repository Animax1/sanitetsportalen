...
# FreezeThawAdminActionTests er fjernet (26. sep. 2026, B4): Django-admin er
# skrivebeskyttet, og frysing skjer bare i portalen — der sesjonene, auditraden
# og sperra mot å fryse seg selv prøves (`accounts/tests_user_admin.py`).
