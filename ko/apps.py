...
class KoConfig(AppConfig):
    ...
    def ready(self):
        ...
        """
        from . import backup, endringer, opprydding, portalinnstillinger, signals, statistikk  # noqa: F401

        backup.register_handlers()
        # Endringsnummeret for tavla (24. sep. 2026). Uten registreringen
        # svarer `/api/endringer/` ingenting for `tavle`, og tavla henter
        # bare på sikkerhetsnettet.
        endringer.register_handlers()
