...
**Og senere samme dag:** B-tallene verken per ansvarsområde eller per person; ingen felt
for forventet publikum; ingen sammenligning mellom vakter per nå (7d står).
