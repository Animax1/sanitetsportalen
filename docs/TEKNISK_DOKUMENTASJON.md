...
Portalen har **128 endepunkter** (utenom Django-admin, som bare rutes under `DEBUG`).
...
Vanlig JavaScript, **ingen rammeverk og ingen bundler**. 23 filer i `static/js/`, fordelt
